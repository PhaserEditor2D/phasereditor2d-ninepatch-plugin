    ...
    (function (ninepatch) {
        ...
        class NinePatchPlugin extends colibri.Plugin {
            ...
            registerExtensions(reg) {
                ...
                reg.addExtension(ninepatch.container.NinePatchContainerExtension.getInstance());
                reg.addExtension(new phasereditor2d.scene.ui.editor.properties.SceneEditorPropertySectionExtension(page => new ninepatch.NinePatchSection(page), page => new ninepatch.container.NinePatchContainerSection(page)));
        ...
        (function (container) {
            class NinePatchContainer extends Phaser.GameObjects.Container {
                constructor(scene, x, y, width, height, key, frame) {
                    ...
                    this._ninePatchContainerOriginX = 0.5;
                    this._ninePatchContainerOriginY = 0.5;
                    this._ninePatchContainerTint = 0xffffff;
                    this._ninePatchContainerTintFill = false;
                    this.width = width;
                    this.height = height;
                    this.textureKey = key;
                    this.textureFrame = frame;
                    this._editorSupport = new container.NinePatchContainerEditorSupport(this, scene);
                    this._dirty = true;
                ...
                redraw() {
                    ...
                    this._originFrame = this._originTexture.frames[this.textureFrame] || this._originTexture.frames[NinePatchContainer.__BASE];
                ...
                createPatches() {
                    for (let row = 0; row < 3; row++) {
                        for (let col = 0; col < 3; col++) {
                            ...
                            this.createPatchFrame(name, this.textureXs[col], // x
                ...
                set ninePatchContainerTintFill(fill) {
                ...
                set ninePatchContainerTint(tint) {
                ...
                set ninePatchContainerOriginX(originX) {
                ...
                set ninePatchContainerOriginY(originY) {
            ...
            NinePatchContainer.__BASE = "__BASE";
            container.NinePatchContainer = NinePatchContainer;
        })(container = ninepatch.container || (ninepatch.container = {}));
    })(ninepatch = phasereditor2d.ninepatch || (phasereditor2d.ninepatch = {}));
})(phasereditor2d || (phasereditor2d = {}));
var phasereditor2d;
(function (phasereditor2d) {
    ...
    (function (ninepatch) {
        ...
        (function (container) {
            var sceneobjects = phasereditor2d.scene.ui.sceneobjects;
            class NinePatchContainerComponent extends sceneobjects.Component {
                constructor(obj) {
                    super(obj, [
                ...
                buildSetObjectPropertiesCodeDOM(args) {
                    this.buildSetObjectPropertyCodeDOM_FloatProperty(args, NinePatchContainerComponent.ninePatchContainerOriginX, NinePatchContainerComponent.ninePatchContainerOriginY);
            ...
            NinePatchContainerComponent.ninePatchContainerOriginX = sceneobjects.SimpleProperty("ninePatchContainerOriginX", 0.5, "Origin X", "Container's origin X.", false);
            NinePatchContainerComponent.ninePatchContainerOriginY = sceneobjects.SimpleProperty("ninePatchContainerOriginY", 0.5, "Origin Y", "Container's origin Y.", false);
            NinePatchContainerComponent.ninePatchContainerTintFill = sceneobjects.SimpleProperty("ninePatchContainerTintFill", false, "Tint Fill", "Tint fill?", false);
            NinePatchContainerComponent.ninePatchContainerTint = sceneobjects.TintProperty("ninePatchContainerTint", "Tint", "The tint of every image in the ninepatch container.");
            container.NinePatchContainerComponent = NinePatchContainerComponent;
        })(container = ninepatch.container || (ninepatch.container = {}));
    })(ninepatch = phasereditor2d.ninepatch || (phasereditor2d.ninepatch = {}));
})(phasereditor2d || (phasereditor2d = {}));
var phasereditor2d;
(function (phasereditor2d) {
    ...
    (function (ninepatch) {
        ...
        (function (container) {
            var sceneobjects = phasereditor2d.scene.ui.sceneobjects;
            class NinePatchContainerEditorSupport extends sceneobjects.GameObjectEditorSupport {
                constructor(obj, scene) {
                    super(container.NinePatchContainerExtension.getInstance(), obj, scene);
                    this.addComponent(new sceneobjects.TextureComponent(obj), new sceneobjects.TransformComponent(obj), new sceneobjects.VisibleComponent(obj), new sceneobjects.SizeComponent(obj), new ninepatch.NinePatchComponent(obj), new container.NinePatchContainerComponent(obj));
                }
                getCellRenderer() {
            ...
            container.NinePatchContainerEditorSupport = NinePatchContainerEditorSupport;
        })(container = ninepatch.container || (ninepatch.container = {}));
    })(ninepatch = phasereditor2d.ninepatch || (phasereditor2d.ninepatch = {}));
})(phasereditor2d || (phasereditor2d = {}));
var phasereditor2d;
(function (phasereditor2d) {
    ...
    (function (ninepatch) {
        var container;
        (function (container) {
            class NinePatchContainerExtension extends phasereditor2d.scene.ui.sceneobjects.BaseImageExtension {
                constructor() {
                    super({
                        phaserTypeName: "NinePatchContainer",
                        typeName: "NinePatchContainer",
                        category: phasereditor2d.scene.SCENE_OBJECT_IMAGE_CATEGORY,
                        icon: ninepatch.NinePatchPlugin.getInstance().getIconDescriptor(ninepatch.ICON_NINEPATCH_CONTAINER)
                    });
                }
                static getInstance() {
                ...
                getCodeDOMBuilder() {
                    return new ninepatch.NinePatchCodeDOMBuilder("ninePatchContainer");
                }
                newObject(scene, x, y, key, frame) {
                    const w = 200;
                    const h = 100;
                    if (key) {
                        return new container.NinePatchContainer(scene, x, y, w, h, key, frame);
                    }
                    return new container.NinePatchContainer(scene, x, y, w, h);
                }
            ...
            container.NinePatchContainerExtension = NinePatchContainerExtension;
        })(container = ninepatch.container || (ninepatch.container = {}));
    })(ninepatch = phasereditor2d.ninepatch || (phasereditor2d.ninepatch = {}));
})(phasereditor2d || (phasereditor2d = {}));
var phasereditor2d;
(function (phasereditor2d) {
    ...
    (function (ninepatch) {
        ...
        (function (container) {
            var sceneobjects = phasereditor2d.scene.ui.sceneobjects;
            class NinePatchContainerSection extends phasereditor2d.scene.ui.sceneobjects.SceneGameObjectSection {
                constructor(page) {
                ...
                createForm(parent) {
                    ...
                    this.createPropertyFloatRow(comp, container.NinePatchContainerComponent.ninePatchContainerOriginX);
                    this.createPropertyFloatRow(comp, container.NinePatchContainerComponent.ninePatchContainerOriginY);
                    this.createPropertyBoolean(comp, container.NinePatchContainerComponent.ninePatchContainerTintFill);
                    this.createPropertyColorRow(comp, container.NinePatchContainerComponent.ninePatchContainerTint, false);
                }
                canEdit(obj, n) {
                    return sceneobjects.GameObjectEditorSupport
                        .hasObjectComponent(obj, container.NinePatchContainerComponent);
                }
                canEditNumber(n) {
                    return n > 0;
                }
            ...
            NinePatchContainerSection.SECTION_ID = "phasereditor2d.ninepatch.container.NinePatchContainerSection";
            container.NinePatchContainerSection = NinePatchContainerSection;
        })(container = ninepatch.container || (ninepatch.container = {}));
    })(ninepatch = phasereditor2d.ninepatch || (phasereditor2d.ninepatch = {}));
})(phasereditor2d || (phasereditor2d = {}));
var phasereditor2d;
